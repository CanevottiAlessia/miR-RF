...
#run_workdir / f"{rnafold_path.name}_final_hairpins.txt"
output_file = out_folder / f"{file_path.name}_insertionProcessed"
...
#output_file = out_folder / f"{file_path.name}_insertionProcessed"
resulting_string = out_folder / f"{file_path.name}_temp_processing_file.txt"
#resulting_string = generate_random_string() + "_temp_processing_file.txt"
...
#output_file = out_folder / f"{file_path.name}_insertionProcessed"
random_file_name = out_folder / f"{file_path.name}_final_hairpins.txt"
