...
input_file = Path(user_file)
user_file2 = Path(user_file2)
out_folder= Path(out_folder)

output_file_activated =out_folder / f"{input_file.name}_temp_activated_hairpins.txt"
...
output_file_deactivated = out_folder / f"{input_file.name}_temp_deactivated_hairpins.txt"
...
output_file_IS = out_folder / f"{input_file.name}_temp_IS_class.tsv"
...
output_file_DR = out_folder / f"{input_file.name}_temp_DR_class.tsv"
