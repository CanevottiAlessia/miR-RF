...
if __name__=="__main__":
    ...
    out_file = sys.argv[4] #percorso /home/acanevotti/ilPostoDaCuiEseguoMain/nomeFile

user_file = Path(user_file)
user_file2 = Path(user_file2)
user_file3 = Path(user_file3)
...
new_classes_final.to_csv(out_file, index=False, sep="\t")
