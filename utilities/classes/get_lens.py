...
output_file =  out_folder / f"{file_path.name}_tempLens"  #f"temp_header_file_for_{user_file}"
...
# Step 4: Extract the tuple with the longest element for each list
extracted_dict = {}
output_file_path = out_folder / f"{file_path.name}_temp_len_hairpins.txt"  # Specify the file name or path
