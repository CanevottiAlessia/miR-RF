...
first_output = out_folder / f"{user_file.name}_col2_classes_temp.txt"

with open(user_file, "r") as f_in, open(first_output, "w") as f_out:
    for line in f_in:
...
second_output = out_folder / f"{user_file.name}_temp.txt"
...
# Example usage
mirbase_output_counts_file = open(second_output, "r") #("mirgene_output_counts", "r")
...
# Example usage
mirbase_output_counts_file = open(second_output, "r")
mirbase_output_counts = mirbase_output_counts_file.readlines()
mirbase_output_counts_file.close()
...
with open(second_output, 'r') as file:
    for line in file:
...
output_file_3= out_folder / f"{user_file.name}_temp_classes_mirna.txt" 
